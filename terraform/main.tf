# terraform/main.tf
# Complete AWS ECS Infrastructure with Blue/Green Deployment
...
resource "aws_codedeploy_deployment_group" "app" {
  ...
  blue_green_deployment_config {
    deployment_ready_option {
      action_on_timeout    = var.environment == "prod" ? "STOP_DEPLOYMENT" : "CONTINUE_DEPLOYMENT"
      wait_time_in_minutes = var.environment == "prod" ? 5 : 0
    }
